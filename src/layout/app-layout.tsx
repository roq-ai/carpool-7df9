...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'team-member', 'driver'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Car Pool', path: '/car-pools', entity: 'car_pool', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Profile', path: '/profiles', entity: 'profile', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
